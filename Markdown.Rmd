...
```{r echo=FALSE, cache=FALSE, results=FALSE, warning=FALSE, comment=TRUE, warning=FALSE} 
...
pct_migrou_virtual <- paste0(round(unname(casos_migrou_virtual) / 
